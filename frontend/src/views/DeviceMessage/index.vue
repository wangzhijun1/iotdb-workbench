    ...
    <div class="content_padding">
      <div class="headerbox">
        ...
        <div class="messageBox">
          ...
          <span>{{ deviceObj.deviceData.dataconnection }}</span>
...
import { getList, deleteDevice, getDeviceDate,getDataDeviceList, randomImport, editData, deleteDeviceData, exportDataCSV, downloadFile, importData } from './api';
